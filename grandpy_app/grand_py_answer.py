...
def grand_py_answer(error):
    ...
    if error:
        ...
        grandpy_answer2 = random.choice(
            [
                "Et mais je connais ce quartier ! Dans le coin tu as un"
                " endroit que je connais bien. J'habitais juste en face ! ",
                "Mais t'ai-je déjà raconté l'histoire de ce quartier qui "
                "m'a vu en culottes courtes ? ",
                "Je pourrais t'en raconter de belles sur ce coin. Tiens "
                "par exemple. "])
